 ...
 *
 */
function(){"use strict";function e(){s.classList.remove("open"),r.classList.remove("open"),a.classList.remove("open")}function t(){s.classList.toggle("open"),r.classList.toggle("open"),a.classList.toggle("open"),a.classList.add("opened")}var n=document.querySelector.bind(document),a=n(".navdrawer-container"),s=document.body,r=n(".app-bar"),o=n(".menu"),l=n("main");l.addEventListener("click",e),o.addEventListener("click",t),a.addEventListener("click",function(t){("A"===t.target.nodeName||"LI"===t.target.nodeName)&&e()})}();